...
public class TextPlainToObjConverter {
	...
	public static <TYPE extends Object> TYPE convert(Class<TYPE> clazz, String body) throws HttpMessageParseException {
		...
		try {
			...
			// アプリケーションに応じたエラーを返却する。
			throw new HttpMessageParseException("text/plainのメッセージ変換処理に失敗しました。", e);
		}
		return obj;
	}
